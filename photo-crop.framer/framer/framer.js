...
},{"./Animators/BezierCurveAnimator":5,"./Animators/LinearAnimator":6,"./Animators/SpringDHOAnimator":7,"./Animators/SpringRK4Animator":8,"./Config":12,"./Defaults":15,"./EventEmitter":17,"./Frame":23,"./Underscore":38,"./Utils":39}],2:[function(require,module,exports){
...
},{"./EventEmitter":17,"./Underscore":38}],3:[function(require,module,exports){
...
},{"./Config":12,"./EventEmitter":17,"./Underscore":38,"./Utils":39}],4:[function(require,module,exports){
var Config, Utils;
...
},{"./Config":12,"./Utils":39}],5:[function(require,module,exports){
...
},{"../Animator":4,"../Underscore":38,"../Utils":39}],6:[function(require,module,exports){
...
},{"../Animator":4,"../Utils":39}],7:[function(require,module,exports){
var Animator, Utils, _ref,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"../Animator":4,"../Utils":39}],8:[function(require,module,exports){
var Animator, Integrator, Utils, _ref,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
exports.SpringRK4Animator = (function(_super) {
  ...
  SpringRK4Animator.prototype.setup = function(options) {
    ...
    return this._integrator = new Integrator(function(state) {
...
},{"../Animator":4,"../Integrator":26,"../Utils":39}],9:[function(require,module,exports){
var Layer,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"./Layer":27}],10:[function(require,module,exports){
...
},{"./EventEmitter":17,"./Underscore":38,"./Utils":39}],11:[function(require,module,exports){
...
},{"./Layer":27}],12:[function(require,module,exports){
var FramerCSS, Utils;
...
},{"./Config":12,"./EventEmitter":17,"./EventManager":18,"./Underscore":38,"./Utils":39}],14:[function(require,module,exports){
...
},{"./Context":13,"./Utils":39}],15:[function(require,module,exports){
...
},{"./Underscore":38,"./Utils":39}],16:[function(require,module,exports){
...
},{"./BaseClass":10,"./Defaults":15,"./Events":19,"./Layer":27,"./Underscore":38,"./Utils":39}],17:[function(require,module,exports){
var EventEmitter;
...
},{"eventemitter3":41}],18:[function(require,module,exports){
...
},{"./Underscore":38,"./Utils":39}],20:[function(require,module,exports){
...
},{"./Animation":1,"./AnimationGroup":2,"./AnimationLoop":3,"./Animators/BezierCurveAnimator":5,"./Animators/LinearAnimator":6,"./Animators/SpringDHOAnimator":7,"./Animators/SpringRK4Animator":8,"./BackgroundLayer":9,"./BaseClass":10,"./Compat":11,"./Config":12,"./Context":13,"./Debug":14,"./Defaults":15,"./DeviceView":16,"./EventEmitter":17,"./Events":19,"./Extras/Extras":20,"./Frame":23,"./Importer":25,"./Layer":27,"./LayerDraggable":28,"./LayerStyle":30,"./Print":31,"./Screen":32,"./Underscore":38,"./Utils":39,"./VideoLayer":40}],25:[function(require,module,exports){
...
},{"./Underscore":38,"./Utils":39}],26:[function(require,module,exports){
var Config, Utils;
...
},{"./Config":12,"./Utils":39}],27:[function(require,module,exports){
...
},{"./Animation":1,"./BaseClass":10,"./Config":12,"./Defaults":15,"./EventEmitter":17,"./Frame":23,"./LayerDraggable":28,"./LayerStates":29,"./LayerStyle":30,"./Underscore":38,"./Utils":39}],28:[function(require,module,exports){
var BaseClass, Events, Frame, Simulation, Utils, _,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
exports.LayerDraggable = (function(_super) {
  ...
  LayerDraggable.VelocityMultiplier = 890;

  LayerDraggable.DragThreshold = 10;

  LayerDraggable.OverscrollScale = 0.5;

  LayerDraggable.SimulationModelOptions = {
    scrollFriction: 2.1,
  ...
  function LayerDraggable(layer) {
    ...
    this._scrollBounds = __bind(this._scrollBounds, this);
    ...
    this.speedX = 1.0;
    this.speedY = 1.0;
    this._maxDragFrame = null;
    this._inertialScroll = false;
    this._xAxisLock = false;
    this._yAxisLock = false;
    this._directionIsLocked = false;
    this._propagateEvents = false;
    this.attach();
  }

  LayerDraggable.define("overscroll", LayerDraggable.simpleProperty("overscroll", null, true));

  LayerDraggable.define("directionLock", LayerDraggable.simpleProperty("directionLock", false, true));

  LayerDraggable.define("multipleDraggables", LayerDraggable.simpleProperty("multipleDraggables", false, true));

  LayerDraggable.define("maxDragFrame", {
    get: function() {
      return this._maxDragFrame;
    },
    set: function(value) {
      if (_.isFunction(value)) {
        this._maxDragFrame = value;
      } else {
        this._maxDragFrame = new Frame(value);
      }
      if (this._inertialScroll) {
        return this._updateInertialScrollBounds();
      }
    }
  });

  LayerDraggable.prototype._scrollBounds = function() {
    var dragFrame, maxDragFrame;
    maxDragFrame = _.result(this, 'maxDragFrame');
    if (maxDragFrame) {
      dragFrame = {
        minX: maxDragFrame.minX,
        minY: maxDragFrame.minY,
        maxX: maxDragFrame.maxX - this.layer.width,
        maxY: maxDragFrame.maxY - this.layer.height
      };
    } else {
      dragFrame = {
        minX: -Infinity,
  ...
  LayerDraggable.prototype._clamp = function(value, min, max) {
    if (value < min) {
      value = min;
    }
    if (value > max) {
  ...
  LayerDraggable.prototype._clampAndScalePastBounds = function(value, min, max, scale) {
    if (value < min) {
  ...
  LayerDraggable.prototype._constrainPositionToBounds = function(position, bounds, scale) {
    var maxX, maxY, minX, minY, newPosition;
    minX = bounds.minX, maxX = bounds.maxX, minY = bounds.minY, maxY = bounds.maxY;
    newPosition = {};
    if (this.overscroll) {
      newPosition.x = this._clampAndScalePastBounds(position.x, minX, maxX, scale);
      newPosition.y = this._clampAndScalePastBounds(position.y, minY, maxY, scale);
    } else {
      newPosition.x = this._clamp(position.x, minX, maxX);
      newPosition.y = this._clamp(position.y, minY, maxY);
    }
    return newPosition;
  };

  LayerDraggable.define("maxScrollFrame", {
    get: function() {
      throw Error("You can only assign to maxScrollFrame, which computes a new \nmaxDragFrame. Try accessing maxDragFrame instead.");
    },
    set: function(value) {
      var height, layerHeightTooSmall, layerWidthTooSmall, width, x, y;
      layerWidthTooSmall = this.layer.width < value.width;
      layerHeightTooSmall = this.layer.height < value.height;
      if (layerWidthTooSmall) {
        x = 0;
        width = this.layer.width;
      } else {
        x = -this.layer.width + value.width;
        width = this.layer.width * 2 - value.width;
      }
      if (layerHeightTooSmall) {
        y = 0;
        height = this.layer.height;
      } else {
        y = -this.layer.height + value.height;
        height = this.layer.height * 2 - value.height;
      }
      return this.maxDragFrame = {
        x: x,
        y: y,
        width: width,
        height: height
  ...
  LayerDraggable.prototype._calculateDraggingVelocity = function() {
    var curr, deltas, earliestValidTime, prev, time, velocity,
      _this = this;
    earliestValidTime = Date.now() - this.constructor.VelocityTimeOut;
    deltas = _.filter(this._deltas, function(delta) {
      return delta.t > earliestValidTime;
    });
    if (deltas.length < 2) {
      return {
        x: 0,
  ...
  LayerDraggable.prototype._calculateInertialScrollingVelocity = function() {
    var correctedVelocity, xFinished, yFinished;
    xFinished = this._simulationX.finished();
    yFinished = this._simulationY.finished();
    correctedVelocity = {
      x: 0,
      y: 0
    };
    if (!xFinished) {
      correctedVelocity.x = this._simulationX.getState().v / this.constructor.VelocityMultiplier;
    }
    if (!yFinished) {
      correctedVelocity.y = this._simulationY.getState().v / this.constructor.VelocityMultiplier;
    }
  ...
  LayerDraggable.prototype.calculateVelocity = function() {
    if (this._isDragging) {
      return this._calculateDraggingVelocity();
    } else if (this._inertialScroll) {
      return this._calculateInertialScrollingVelocity();
    } else {
      return {
        x: 0,
        y: 0
  ...
  LayerDraggable.prototype._updateDirectionLock = function(correctedDelta) {
    ...
    this._xAxisLock = Math.abs(correctedDelta.x) > this.constructor.DragThreshold;
    this._yAxisLock = Math.abs(correctedDelta.y) > this.constructor.DragThreshold;
    xSlightlyPreferred = Math.abs(correctedDelta.x) > this.constructor.DragThreshold / 2;
    ySlightlyPreferred = Math.abs(correctedDelta.y) > this.constructor.DragThreshold / 2;
    if (xSlightlyPreferred && ySlightlyPreferred) {
      this._xAxisLock = this._yAxisLock = true;
    }
    if (this._xAxisLock || this._yAxisLock) {
      this._directionIsLocked = true;
      this.emit(Events.DirectionLock, {
        x: this._xAxisLock,
        y: this._yAxisLock
      });
      if (this.multipleDraggables) {
        return this._propagateEvents = false;
      }
    }
  };
  ...
  LayerDraggable.prototype._updatePosition = function(event) {
    ...
    this._position.x = parseInt(this._start.x + correctedDelta.x - this._offset.x);
    this._position.y = parseInt(this._start.y + correctedDelta.y - this._offset.y);
    if (this.maxDragFrame) {
      this._position = this._constrainPositionToBounds(this._position, this._scrollBounds(), this.constructor.OverscrollScale);
    }
    if (this.directionLock) {
      if (!this._directionIsLocked) {
        this._updateDirectionLock(correctedDelta);
      }
      if (this._xAxisLock) {
        this.layer.x = this._position.x;
      }
      if (this._yAxisLock) {
        this.layer.y = this._position.y;
      }
    } else {
      this.layer.x = this._position.x;
      this.layer.y = this._position.y;
  ...
  LayerDraggable.prototype._touchStart = function(event) {
    var touchEvent;
    if (this.multipleDraggables && this.directionLock) {
    ...
    if (this.overscroll) {
      this._position = this._constrainPositionToBounds(this._position, this._scrollBounds(), 1 / this.constructor.OverscrollScale);
    }
    touchEvent = Events.touchEvent(event);
    this._start = {
    ...
    this._offset = {
      x: touchEvent.clientX - this._position.x,
      y: touchEvent.clientY - this._position.y
    };
    this._screenScale = {
  ...
  LayerDraggable.define("inertialScroll", {
    get: function() {
      return this._inertialScroll;
    },
    set: function(value) {
      var _ref, _ref1,
        _this = this;
      this._inertialScroll = value;
      if (this._inertialScroll) {
        if (this.overscroll == null) {
          this.overscroll = true;
        }
        if (this._simulationX == null) {
          this._simulationX = new Simulation({
            layer: this.layer,
            properties: {
              x: true
            },
            model: "inertial-scroll",
            modelOptions: this.constructor.SimulationModelOptions
          });
        }
        if (this._simulationY == null) {
          this._simulationY = new Simulation({
            layer: this.layer,
            properties: {
              y: true
            },
        ...
        this._simulationX.on(Events.SimulationStep, function(state) {
          var maxX, minX, _ref;
          if (_this.overscroll) {
            return _this.layer.x = state.x;
          } else {
            _ref = _this._scrollBounds(), minX = _ref.minX, maxX = _ref.maxX;
            return _this.layer.x = _this._clamp(state.x, minX, maxX);
          }
        });
        this._simulationY.on(Events.SimulationStep, function(state) {
          var maxY, minY, _ref;
          if (_this.overscroll) {
            return _this.layer.y = state.x;
          } else {
            _ref = _this._scrollBounds(), minY = _ref.minY, maxY = _ref.maxY;
            return _this.layer.y = _this._clamp(state.x, minY, maxY);
          }
        });
        this._updateInertialScrollBounds();
        return this._startSimulation();
      } else {
        if ((_ref = this._simulationX) != null) {
          _ref.off(Events.SimulationStep);
        }
        if ((_ref1 = this._simulationY) != null) {
          _ref1.off(Events.SimulationStep);
        }
  ...
  LayerDraggable.prototype._updateInertialScrollBounds = function() {
    var maxX, maxY, minX, minY, _ref;
    _ref = this._scrollBounds(), minX = _ref.minX, maxX = _ref.maxX, minY = _ref.minY, maxY = _ref.maxY;
    this._simulationX.setOptions({
      min: minX,
      max: maxX
    });
    return this._simulationY.setOptions({
      min: minY,
      max: maxY
    });
  };
  ...
  LayerDraggable.prototype._startSimulation = function() {
    ...
    this._simulationY.start();
    this._simulationY.setState({
      x: this.layer.y,
      v: velocity.y * this.constructor.VelocityMultiplier
    });
    this._simulationX.start();
    return this._simulationX.setState({
      x: this.layer.x,
      v: velocity.x * this.constructor.VelocityMultiplier
    });
  };
  ...
  LayerDraggable.prototype._stopSimulation = function() {
    ...
    return (_ref1 = this._simulationY) != null ? _ref1.stop() : void 0;
  };
...
},{"./BaseClass":10,"./Events":19,"./Frame":23,"./Simulation":33,"./Underscore":38,"./Utils":39}],29:[function(require,module,exports){
...
},{"./BaseClass":10,"./Defaults":15,"./Events":19,"./Underscore":38}],30:[function(require,module,exports){
...
},{"./Context":13,"./Utils":39}],32:[function(require,module,exports){
...
},{"./BaseClass":10}],33:[function(require,module,exports){
var Config, Defaults, EventEmitter, Events, FrictionSimulator, InertialScrollSimulator, SimulatorClasses, SpringSimulator, Utils, _,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
...
InertialScrollSimulator = require("./Simulators/InertialScrollSimulator").InertialScrollSimulator;
...
exports.Simulation = (function(_super) {
  ...
  Simulation.prototype.start = function() {
    ...
    _ref = this.options.layer.animatingProperties();
  ...
  Simulation.prototype.copy = function() {
    return new Simulation(_.clone(this.options));
  };
  ...
  Simulation.prototype.getState = function() {
    return this._simulator.getState();
  };

  Simulation.prototype.setState = function(state) {
    return this._simulator.setState(state);
  };

  Simulation.prototype.setOptions = function(options) {
    return this._simulator.setOptions(options);
  };
...
},{"./Config":12,"./Defaults":15,"./EventEmitter":17,"./Events":19,"./Simulators/FrictionSimulator":35,"./Simulators/InertialScrollSimulator":36,"./Simulators/SpringSimulator":37,"./Underscore":38,"./Utils":39}],34:[function(require,module,exports){
var Config, Utils;
...
},{"./Config":12,"./Utils":39}],35:[function(require,module,exports){
var Integrator, Simulator, Utils, _ref,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
exports.FrictionSimulator = (function(_super) {
  __extends(FrictionSimulator, _super);

  function FrictionSimulator() {
    this.finished = __bind(this.finished, this);
    _ref = FrictionSimulator.__super__.constructor.apply(this, arguments);
    return _ref;
  }
...
},{"../Integrator":26,"../Simulator":34,"../Utils":39}],36:[function(require,module,exports){
var FrictionSimulator, Simulator, SpringSimulator, Utils, _ref,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
exports.InertialScrollSimulator = (function(_super) {
  __extends(InertialScrollSimulator, _super);

  function InertialScrollSimulator() {
    this.finished = __bind(this.finished, this);
    _ref = InertialScrollSimulator.__super__.constructor.apply(this, arguments);
    return _ref;
  }

  InertialScrollSimulator.prototype.setup = function(options) {
    this.options = Utils.setDefaultProperties(options, {
      scrollFriction: 2.1,
      scrollTolerance: 1 / 10,
      springFriction: 40,
    ...
    this._frictionSimulator = new FrictionSimulator({
      ...
      tolerance: this.options.scrollTolerance,
      velocity: this.options.velocity,
      position: this.options.position
    });
    this._springSimulator = new SpringSimulator({
      tension: this.options.springTension,
      friction: this.options.springFriction,
      tolerance: this.options.springTolerance,
      velocity: this.options.velocity,
      position: this.options.position
    });
    this._state = {
  ...
  InertialScrollSimulator.prototype.next = function(delta) {
    if (this._useSpring) {
  ...
  InertialScrollSimulator.prototype.finished = function() {
    if (this._useSpring) {
  ...
  InertialScrollSimulator.prototype.setState = function(state) {
    var bound;
    this._state = {
      x: state.x,
      v: state.v
  ...
  InertialScrollSimulator.prototype._tryTransitionToSpring = function(force) {
  ...
  InertialScrollSimulator.prototype._transitionToSpring = function(bound) {
    this._useSpring = true;
    this._springSimulator.options.offset = bound;
    return this._springSimulator.setState(this._state);
  };

  InertialScrollSimulator.prototype._isValidState = function() {
  ...
  return InertialScrollSimulator;

})(Simulator);


},{"../Simulator":34,"../Utils":39,"./FrictionSimulator":35,"./SpringSimulator":37}],37:[function(require,module,exports){
var Integrator, Simulator, Utils, _ref,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
exports.SpringSimulator = (function(_super) {
  __extends(SpringSimulator, _super);

  function SpringSimulator() {
    this.finished = __bind(this.finished, this);
    _ref = SpringSimulator.__super__.constructor.apply(this, arguments);
    return _ref;
  }
...
},{"../Integrator":26,"../Simulator":34,"../Utils":39}],38:[function(require,module,exports){
var _;
...
},{"lodash":42,"underscore.string":43}],39:[function(require,module,exports){
...
},{"./Screen":32,"./Underscore":38}],40:[function(require,module,exports){
var Layer,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"./Layer":27}],41:[function(require,module,exports){
'use strict';
